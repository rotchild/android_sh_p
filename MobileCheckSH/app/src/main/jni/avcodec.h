...
// ben add 2005 07 05 start
#define CODEC_FLAG_PICT_ALLOC_EXTERNAL      0x04000000 ///< when decode finish, return picture pointer allocated in CODEC externallly
// end
...
#define FF_MB_DECISION_RD     2        ///< rate distoration
	...
	// ben 2005 0306: add for decoding to frame buffer directly
    int framebuffer_rgb_stride;
    int framebuffer_rgb_height;
    /** leo add on 2005- 11-17 for motion jpeg encoder's options */
    int fmjpeg_image_quality; /**<  default i s 75 for fmjpeg image quality (0 ~ 100) */
    int fmjpeg_restart; /**<  default is 0 , means no restart marker */
    int fmjpeg_yuv_format; /**<  // default is  0,  for YUV 420 */
    int fmjpeg_jpeg;	
    /** leo added for h264 encoder's options */
    unsigned int fh264_quant;  /**<  the fh264 codec quant value (0~ 51) */
    unsigned int fh264_ip;     /**<  the fh264 codec i-p interval value */
    int fmpeg4_qtbl;	
    int grabtype;                     /**<  0:for MP4 2D, 1:for JPG Seq in 8120  
                                                        0:for MP4 2D, 1:for JPG Seq, 2:for H264 2D in 8180*/
} AVCodecContext;
